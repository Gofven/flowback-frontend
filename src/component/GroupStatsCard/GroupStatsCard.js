        ...
        userType === "Owner" ?
            <div className="document-card card-rounded mb-4">
                <div className="card-header flex-header tab-header">
                    <h4 className="card-title">{window.t("Group statistics")}</h4>
                </div>
                ...
                <div className="card-header flex-header tab-header">
                    <h4 className="card-title">
                        {window.t("Group statistics")}</h4>
                </div>
                <div className="card-body text-danger">{window.t("Only an Admin is allowed to view group statistics")}.</div>
            </div>)
}
...
function StatsNumberCard({ label = "label", number = 0 }) {
    return <div className="card m-2" style={{ width: "8rem" }}>
        <div className="card-body">
            <p className="mb-1 text-secondary ">{window.t(label)}</p>
