        ...
        {poll && poll.created_by &&
          <div className="media post-meida">
            ...
            <div className="media-body">
              ...
              <div className="post-time">started at: {poll && formatDate(poll.created_at, 'DD/MM/YYYY kk:mm')}</div>
              <div className="post-time">ends at: {poll && formatDate(poll.end_time, 'DD/MM/YYYY kk:mm')}</div>
            </div>
